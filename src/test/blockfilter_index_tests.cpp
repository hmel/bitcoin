...
{
    BlockFilterIndex filter_index(BlockFilterType::BASIC, m_args.GetDataDirNet(), 1 << 20, true);
...
BOOST_FIXTURE_TEST_CASE(blockfilter_index_init_destroy, BasicTestingSetup)
{
    ...
    BOOST_CHECK(InitBlockFilterIndex(BlockFilterType::BASIC, m_args.GetDataDirNet(), 1 << 20, true, false));
